...
To report a bug/request please file an issue in the right repository (example for [STM32CubeH7](https://github.com/STMicroelectronics/STM32CubeH7/issues/new/choose)).
